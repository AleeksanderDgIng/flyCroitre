...
export class SeguridadService {
  ...
  //adicionamos la variable para hacer la solicitudes http 
  constructor(
  ...
  //Definimos las variables globales de la clase, arriba del constructor
  url = "http://localhost:3000";
  sessionUserData = new BehaviorSubject<UsuarioModelo>(new UsuarioModelo());


  //Implementamos el método para iniciar sesión
